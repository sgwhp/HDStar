	...
	public LoadingLayout(Context context, final Mode mode,
		...
		case PULL_FROM_END:
			...
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrFooterPullText)) {
				mPullLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrFooterPullText);
			} else {
				mPullLabel = context
						.getString(R.string.pull_to_refresh_from_bottom_pull_label);
			}
			if (attrs
					.hasValue(R.styleable.PullToRefresh_ptrFooterRefreshingText)) {
				mRefreshingLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrFooterRefreshingText);
			} else {
			...
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrFooterReleaseText)) {
				mReleaseLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrFooterReleaseText);
			} else {
		...
		default:
			...
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrHeaderPullText)) {
				mPullLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrHeaderPullText);
			} else {
				mPullLabel = context
						.getString(R.string.pull_to_refresh_pull_label);
			}
			if (attrs
					.hasValue(R.styleable.PullToRefresh_ptrHeaderRefreshingText)) {
				mRefreshingLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrHeaderRefreshingText);
			} else {
				mRefreshingLabel = context
			...
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrHeaderReleaseText)) {
				mReleaseLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrHeaderReleaseText);
			} else {
				mReleaseLabel = context
